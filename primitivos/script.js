...
let number1 = 29; //se puede poner varios tipos de datos, por si consumimos un backend, para recibir distintos tipos de datos en una variable
let number2 = 35;
let number3 = 6;
let bonus = true;
let palabras = "probando typescript";
...
function mayor(num1, num2, comodin) {
    if (comodin) {
        num1 += number3;
    }
    if (num1 > num2) {
